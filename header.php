...
<script src="https://cdn.tailwindcss.com"></script>
 ...
 <!-- Bloc Navigation -->
  ...
  <nav class="bg-amber-300 pt-8
   pb-8">
    <div class="container px-4 mx-auto md:flex md:items-center">

      <div class="flex justify-between items-center">
        <a href="accueil.php" class="font-bold text-xl text-black-300">DiLAB</a>
    ...
    <a href="accueil.php" class="p-2 lg:px-4 md:mx-2 text-gray-600 hover:bg-gray-200 rounded">Accueil</a>
    <?php if ($_SESSION['id']): ?>
        <?php if ($user_type_id === 1 || $user_type_id === 3 ): ?>
          <a href="promo.php" class="p-2 lg:px-4 md:mx-2 text-gray-600 rounded hover:bg-gray-200 hover:text-gray-700 transition-colors duration-300">Promo</a>
            <?php if ($user_type_id === 1): ?>
              <a href="userlist.php" class="p-2 lg:px-4 md:mx-2 text-gray-600 text-center border border-transparent rounded hover:bg-indigo-100 hover:text-gray-700 transition-colors duration-300">Utilisateur</a>
                <?php endif; ?>
        <?php endif; ?>
    ...
    <form action="logout.php" method="post">
        <button type="submit" name="logout" class="p-2 lg:px-4 md:mx-2 text-black-600 text-center border border-solid border-gray-600 rounded hover:bg-gray-600 hover:text-white transition-colors duration-300 mt-1 md:mt-0 md:ml-1">Se déconnecter</button>
    </form>
    <?php endif; ?>
</div>
